...
var APP_ID = 'M5NkQJKWvG7CmDnj7DaHYWWo2LtCRfxGglfVLBhH';
var API_KEY = 'eZ86MIUDPyhT9FWNw1M72go84XokkndEN2BfwBzd';
...
var _person_collection = require('./person_collection');

var _person_collection2 = _interopRequireDefault(_person_collection);
...
var personCollection = _backbone2['default'].Collection.extend({
...
var Router = _backbone2['default'].Router.extend({
  ...
  home: function home() {
    ...
    this.people.fetch().then((function () {
      this.$el.html((0, _viewsHome2['default'])(this.people.toJSON()));
    }).bind(this));
  },
  ...
  person1page: function person1page(nameId) {
    var _this = this;
    ...
    if (dude) {
      ...
      (function () {
        ...
        dude.fetch().then(function () {
          router.$el.html((0, _viewsPerson2['default'])(dude.toJSON()));
        });
      })();
    }
  },
