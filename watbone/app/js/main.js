...
var _object_collection = require('./object_collection');

var _object_collection2 = _interopRequireDefault(_object_collection);

var _object_template = require('./object_template');

var _object_template2 = _interopRequireDefault(_object_template);

console.log('Hello, World');
_jquery2['default'].ajaxSetup({ //automatically adds these headers to any request that Backbone makes (using $jaKweery)
  headers: {
...
var group = new _object_collection2['default']();
...
var ObjectGroup = _backbone2['default'].Collection.extend({
  url: 'https://api.parse.com/1/classes/items',

  model: _objects2['default'],
...
exports['default'] = ObjectGroup;
module.exports = exports['default'];

},{"./objects":4,"backbone":5}],3:[function(require,module,exports){
"use strict";
...
var objectModel = _backbone2['default'].Model.extend({ //creating new constructor specifically for people (customized)
